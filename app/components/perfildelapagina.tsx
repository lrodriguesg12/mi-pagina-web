			...
			<div className="max-w-4xl flex items-center h-auto flex-wrap mx-auto my-32 lg:my-0">
				<div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
					<div className="p-4 md:p-12 text-center lg:text-left">
						<div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center bg-[url(app/components/javichuuu.jpg)]"></div>
				...
				<div className="w-full lg:w-2/5">
					<img src="app/components/javichuuu.jpg" className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" />
				</div>
			</div>
	)
}
